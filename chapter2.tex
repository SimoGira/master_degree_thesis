...
Note that since KubeEdge is built upon Kubernetes all the tools available in Kubernetes are also available in KubeEdge. Therefore we can benefit of the all monitoring platforms such as the dashboard shown in the previous section.
